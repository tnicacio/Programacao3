...
public class ListRecipesJPanel extends JPanel {
	...
	public ListRecipesJPanel() {
		...
		createsRecipeFinder();
		createsRecipeTableListWithScrollAndRowSorter();
		populate();
	}
		
	private void createsRecipeFinder() {
	...
	private void createsRecipeTableListWithScrollAndRowSorter() {
