...
public class Recipe{
	...
	public String toString() {
		...
		StringBuilder sb = new StringBuilder()
				.append("{")
				.append("id: ").append(getId()).append(comma).append(newLine)
		...
		.append("createdAt: ").append(getCreatedAt()).append(comma).append(newLine)
		.append("updatedAt: ").append(getUpdatedAt()).append(newLine)
		.append("}");
		return sb.toString();
	}
